        ...
        <main>
            <section className="relative h-screen min-h-[650px] w-full overflow-hidden">
                ...
                <motion.img
                    ...
                    src="https://images.unsplash.com/photo-1550005809-91ad75fb315f?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <section className="bg-[#f8f5ef] px-6 py-20 sm:px-10 sm:py-24 lg:px-14 lg:py-28">
                <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
                    ...
                    >
                        <img
                            src="https://images.unsplash.com/photo-1561593367-66c79c2294e6?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <section className="relative h-[650px] min-h-[600px] w-full overflow-hidden sm:h-[750px]">
                <motion.img
                    ...
                    src="https://images.unsplash.com/photo-1481653125770-b78c206c59d4?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
